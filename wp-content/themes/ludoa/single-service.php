...
// Banner: featured image → per-service static banner.webp (PC & SP) → CSS default.
$banner_style = ludoa_bg_style( null, 'full' );
if ( ! $banner_style ) {
	$slug = get_post_field( 'post_name' );
	if ( file_exists( get_template_directory() . "/static/{$slug}/img/banner.webp" ) ) {
		$banner_style = ' style="background-image: url(\'' . esc_url( "{$s}/{$slug}/img/banner.webp" ) . '\')"';
	}
}
?>
<main>
