 ...
 */
namespace SolidWP\Mail\StellarWP\Telemetry;

use SolidWP\Mail\StellarWP\ContainerContract\ContainerInterface;
use SolidWP\Mail\StellarWP\Telemetry\Admin\Admin_Subscriber;
use SolidWP\Mail\StellarWP\Telemetry\Admin\Resources;
use SolidWP\Mail\StellarWP\Telemetry\Contracts\Data_Provider;
use SolidWP\Mail\StellarWP\Telemetry\Data_Providers\Debug_Data;
use SolidWP\Mail\StellarWP\Telemetry\Events\Event_Subscriber;
use SolidWP\Mail\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use SolidWP\Mail\StellarWP\Telemetry\Exit_Interview\Template;
use SolidWP\Mail\StellarWP\Telemetry\Last_Send\Last_Send;
use SolidWP\Mail\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use SolidWP\Mail\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use SolidWP\Mail\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use SolidWP\Mail\StellarWP\Telemetry\Opt_In\Status;
use SolidWP\Mail\StellarWP\Telemetry\Telemetry\Telemetry;
use SolidWP\Mail\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
/**
...
class Core
{
     ...
     * @since 1.0.0
     *
     * @return \SolidWP\Mail\StellarWP\ContainerContract\ContainerInterface
     */
