 ...
 */
namespace SolidWP\Mail\StellarWP\Telemetry\Exit_Interview;

use SolidWP\Mail\StellarWP\ContainerContract\ContainerInterface;
use SolidWP\Mail\StellarWP\Telemetry\Admin\Resources;
use SolidWP\Mail\StellarWP\Telemetry\Config;
use SolidWP\Mail\StellarWP\Telemetry\Contracts\Template_Interface;
/**
...
class Template implements Template_Interface
{
     ...
     * @since 1.0.0
     *
     * @var \SolidWP\Mail\StellarWP\ContainerContract\ContainerInterface
     */
    protected $container;
    /**
     ...
     * @since 1.0.0
     *
     * @param \SolidWP\Mail\StellarWP\ContainerContract\ContainerInterface $container The container.
     */
